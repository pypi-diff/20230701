# Comparing `tmp/chat-box-streamlit-0.0.93.tar.gz` & `tmp/chat-box-streamlit-0.0.94.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "chat-box-streamlit-0.0.93.tar", last modified: Sat Jul  1 10:33:54 2023, max compression
+gzip compressed data, was "chat-box-streamlit-0.0.94.tar", last modified: Sat Jul  1 10:56:13 2023, max compression
```

## Comparing `chat-box-streamlit-0.0.93.tar` & `chat-box-streamlit-0.0.94.tar`

### file list

```diff
@@ -1,15 +1,15 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-01 10:33:54.659867 chat-box-streamlit-0.0.93/
--rw-r--r--   0 runner    (1001) docker     (123)     1063 2023-07-01 10:33:42.000000 chat-box-streamlit-0.0.93/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       54 2023-07-01 10:33:42.000000 chat-box-streamlit-0.0.93/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     4256 2023-07-01 10:33:54.659867 chat-box-streamlit-0.0.93/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     3921 2023-07-01 10:33:42.000000 chat-box-streamlit-0.0.93/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-01 10:33:54.659867 chat-box-streamlit-0.0.93/chat_box_streamlit/
--rw-r--r--   0 runner    (1001) docker     (123)     1480 2023-07-01 10:33:42.000000 chat-box-streamlit-0.0.93/chat_box_streamlit/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-01 10:33:54.659867 chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     4256 2023-07-01 10:33:54.000000 chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      278 2023-07-01 10:33:54.000000 chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-01 10:33:54.000000 chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-01 10:33:54.000000 chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       19 2023-07-01 10:33:54.000000 chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-01 10:33:54.659867 chat-box-streamlit-0.0.93/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      609 2023-07-01 10:33:42.000000 chat-box-streamlit-0.0.93/setup.py
...
### Comparing `chat-box-streamlit-0.0.93/LICENSE` & `chat-box-streamlit-0.0.94/LICENSE`

 * *Files identical despite different names*

### Comparing `chat-box-streamlit-0.0.93/PKG-INFO` & `chat-box-streamlit-0.0.94/PKG-INFO`
...
### Comparing `chat-box-streamlit-0.0.93/README.md` & `chat-box-streamlit-0.0.94/README.md`

 * *Files identical despite different names*

### Comparing `chat-box-streamlit-0.0.93/chat_box_streamlit/__init__.py` & `chat-box-streamlit-0.0.94/chat_box_streamlit/__init__.py`
...
### Comparing `chat-box-streamlit-0.0.93/chat_box_streamlit.egg-info/PKG-INFO` & `chat-box-streamlit-0.0.94/chat_box_streamlit.egg-info/PKG-INFO`
...
### Comparing `chat-box-streamlit-0.0.93/setup.py` & `chat-box-streamlit-0.0.94/setup.py`
