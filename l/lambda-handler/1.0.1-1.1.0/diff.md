# Comparing `tmp/lambda-handler-1.0.1.tar.gz` & `tmp/lambda_handler-1.1.0.tar.gz`
...
### Comparing `lambda-handler-1.0.1/lambda_handler/model/sns.py` & `lambda_handler-1.1.0/lambda_handler/model/sns.py`
