# Comparing `tmp/flytekitplugins-data-fsspec-1.7.1b0.tar.gz` & `tmp/flytekitplugins-data-fsspec-1.7.1b1.tar.gz`
...
## Comparing `flytekitplugins-data-fsspec-1.7.1b0.tar` & `flytekitplugins-data-fsspec-1.7.1b1.tar`
...
### Comparing `flytekitplugins-data-fsspec-1.7.1b0/PKG-INFO` & `flytekitplugins-data-fsspec-1.7.1b1/PKG-INFO`
...
### Comparing `flytekitplugins-data-fsspec-1.7.1b0/flytekitplugins_data_fsspec.egg-info/PKG-INFO` & `flytekitplugins-data-fsspec-1.7.1b1/flytekitplugins_data_fsspec.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-data-fsspec-1.7.1b0/setup.py` & `flytekitplugins-data-fsspec-1.7.1b1/setup.py`
