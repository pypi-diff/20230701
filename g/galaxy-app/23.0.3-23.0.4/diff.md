# Comparing `tmp/galaxy-app-23.0.3.tar.gz` & `tmp/galaxy-app-23.0.4.tar.gz`
...
### Comparing `galaxy-app-23.0.3/HISTORY.rst` & `galaxy-app-23.0.4/HISTORY.rst`
...
### Comparing `galaxy-app-23.0.3/LICENSE` & `galaxy-app-23.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/PKG-INFO` & `galaxy-app-23.0.4/PKG-INFO`
...
### Comparing `galaxy-app-23.0.3/galaxy/actions/library.py` & `galaxy-app-23.0.4/galaxy/actions/library.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/app.py` & `galaxy-app-23.0.4/galaxy/app.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/app_unittest_utils/galaxy_mock.py` & `galaxy-app-23.0.4/galaxy/app_unittest_utils/galaxy_mock.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/app_unittest_utils/tools_support.py` & `galaxy-app-23.0.4/galaxy/app_unittest_utils/tools_support.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/authnz/__init__.py` & `galaxy-app-23.0.4/galaxy/authnz/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/authnz/custos_authnz.py` & `galaxy-app-23.0.4/galaxy/authnz/custos_authnz.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/authnz/managers.py` & `galaxy-app-23.0.4/galaxy/authnz/managers.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/authnz/psa_authnz.py` & `galaxy-app-23.0.4/galaxy/authnz/psa_authnz.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/celery/__init__.py` & `galaxy-app-23.0.4/galaxy/celery/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/celery/_serialization.py` & `galaxy-app-23.0.4/galaxy/celery/_serialization.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/celery/tasks.py` & `galaxy-app-23.0.4/galaxy/celery/tasks.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/config_watchers.py` & `galaxy-app-23.0.4/galaxy/config_watchers.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/dependencies/__init__.py` & `galaxy-app-23.0.4/galaxy/dependencies/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/dependencies/conditional-requirements.txt` & `galaxy-app-23.0.4/galaxy/dependencies/conditional-requirements.txt`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/dependencies/dev-requirements.txt` & `galaxy-app-23.0.4/galaxy/dependencies/dev-requirements.txt`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/dependencies/pinned-requirements.txt` & `galaxy-app-23.0.4/galaxy/dependencies/pinned-requirements.txt`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/dependencies/update.sh` & `galaxy-app-23.0.4/galaxy/dependencies/update.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/dependencies/update_lint_requirements.sh` & `galaxy-app-23.0.4/galaxy/dependencies/update_lint_requirements.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/di.py` & `galaxy-app-23.0.4/galaxy/di.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/forms/forms.py` & `galaxy-app-23.0.4/galaxy/forms/forms.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/command_factory.py` & `galaxy-app-23.0.4/galaxy/jobs/command_factory.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/dynamic_tool_destination.py` & `galaxy-app-23.0.4/galaxy/jobs/dynamic_tool_destination.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/handler.py` & `galaxy-app-23.0.4/galaxy/jobs/handler.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/manager.py` & `galaxy-app-23.0.4/galaxy/jobs/manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/mapper.py` & `galaxy-app-23.0.4/galaxy/jobs/mapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/rule_helper.py` & `galaxy-app-23.0.4/galaxy/jobs/rule_helper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/aws.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/aws.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/chronos.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/chronos.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/cli.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/cli.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/condor.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/condor.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/drmaa.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/drmaa.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/godocker.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/godocker.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/kubernetes.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/kubernetes.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/local.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/local.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/pbs.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/pbs.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/pulsar.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/pulsar.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/slurm.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/slurm.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/state_handler_factory.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/state_handler_factory.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/state_handlers/_safe_eval.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/state_handlers/_safe_eval.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/state_handlers/resubmit.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/state_handlers/resubmit.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/tasks.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/tasks.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/univa.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/univa.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/job/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/job/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/job/lsf.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/job/lsf.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/job/pbs.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/job/pbs.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/job/slurm.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/job/slurm.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/job/slurm_torque.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/job/slurm_torque.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/job/torque.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/job/torque.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/shell/local.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/shell/local.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/cli/shell/rsh.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/cli/shell/rsh.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/condor/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/condor/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/env.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/env.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/external.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/external.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/fork_safe_write.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/fork_safe_write.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/job_script/CLUSTER_SLOTS_STATEMENT.sh` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/job_script/CLUSTER_SLOTS_STATEMENT.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/job_script/DEFAULT_JOB_FILE_TEMPLATE.sh` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/job_script/DEFAULT_JOB_FILE_TEMPLATE.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/job_script/MEMORY_STATEMENT_TEMPLATE.sh` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/job_script/MEMORY_STATEMENT_TEMPLATE.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/job_script/__init__.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/job_script/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/kill.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/kill.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/process_groups.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/process_groups.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/pykube_util.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/pykube_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/runners/util/sudo.py` & `galaxy-app-23.0.4/galaxy/jobs/runners/util/sudo.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/splitters/basic.py` & `galaxy-app-23.0.4/galaxy/jobs/splitters/basic.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/splitters/multi.py` & `galaxy-app-23.0.4/galaxy/jobs/splitters/multi.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/jobs/stock_rules.py` & `galaxy-app-23.0.4/galaxy/jobs/stock_rules.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/main.py` & `galaxy-app-23.0.4/galaxy/main.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/main_config.py` & `galaxy-app-23.0.4/galaxy/main_config.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/__init__.py` & `galaxy-app-23.0.4/galaxy/managers/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/annotatable.py` & `galaxy-app-23.0.4/galaxy/managers/annotatable.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/api_keys.py` & `galaxy-app-23.0.4/galaxy/managers/api_keys.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/base.py` & `galaxy-app-23.0.4/galaxy/managers/base.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/citations.py` & `galaxy-app-23.0.4/galaxy/managers/citations.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/cloud.py` & `galaxy-app-23.0.4/galaxy/managers/cloud.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/cloudauthzs.py` & `galaxy-app-23.0.4/galaxy/managers/cloudauthzs.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/collections.py` & `galaxy-app-23.0.4/galaxy/managers/collections.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/collections_util.py` & `galaxy-app-23.0.4/galaxy/managers/collections_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/configuration.py` & `galaxy-app-23.0.4/galaxy/managers/configuration.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/context.py` & `galaxy-app-23.0.4/galaxy/managers/context.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/datasets.py` & `galaxy-app-23.0.4/galaxy/managers/datasets.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/datatypes.py` & `galaxy-app-23.0.4/galaxy/managers/datatypes.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/deletable.py` & `galaxy-app-23.0.4/galaxy/managers/deletable.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/display_applications.py` & `galaxy-app-23.0.4/galaxy/managers/display_applications.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/executables.py` & `galaxy-app-23.0.4/galaxy/managers/executables.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/export_tracker.py` & `galaxy-app-23.0.4/galaxy/managers/export_tracker.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/folders.py` & `galaxy-app-23.0.4/galaxy/managers/folders.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/genomes.py` & `galaxy-app-23.0.4/galaxy/managers/genomes.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/group_roles.py` & `galaxy-app-23.0.4/galaxy/managers/group_roles.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/group_users.py` & `galaxy-app-23.0.4/galaxy/managers/group_users.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/groups.py` & `galaxy-app-23.0.4/galaxy/managers/groups.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/hdas.py` & `galaxy-app-23.0.4/galaxy/managers/hdas.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/hdcas.py` & `galaxy-app-23.0.4/galaxy/managers/hdcas.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/histories.py` & `galaxy-app-23.0.4/galaxy/managers/histories.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/history_contents.py` & `galaxy-app-23.0.4/galaxy/managers/history_contents.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/interactivetool.py` & `galaxy-app-23.0.4/galaxy/managers/interactivetool.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/job_connections.py` & `galaxy-app-23.0.4/galaxy/managers/job_connections.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/jobs.py` & `galaxy-app-23.0.4/galaxy/managers/jobs.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/lddas.py` & `galaxy-app-23.0.4/galaxy/managers/lddas.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/libraries.py` & `galaxy-app-23.0.4/galaxy/managers/libraries.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/library_datasets.py` & `galaxy-app-23.0.4/galaxy/managers/library_datasets.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/licenses.json` & `galaxy-app-23.0.4/galaxy/managers/licenses.json`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/licenses.py` & `galaxy-app-23.0.4/galaxy/managers/licenses.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/markdown_parse.py` & `galaxy-app-23.0.4/galaxy/managers/markdown_parse.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/markdown_util.py` & `galaxy-app-23.0.4/galaxy/managers/markdown_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/metrics.py` & `galaxy-app-23.0.4/galaxy/managers/metrics.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/model_stores.py` & `galaxy-app-23.0.4/galaxy/managers/model_stores.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/pages.py` & `galaxy-app-23.0.4/galaxy/managers/pages.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/quotas.py` & `galaxy-app-23.0.4/galaxy/managers/quotas.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/ratable.py` & `galaxy-app-23.0.4/galaxy/managers/ratable.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/rbac_secured.py` & `galaxy-app-23.0.4/galaxy/managers/rbac_secured.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/remote_files.py` & `galaxy-app-23.0.4/galaxy/managers/remote_files.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/roles.py` & `galaxy-app-23.0.4/galaxy/managers/roles.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/secured.py` & `galaxy-app-23.0.4/galaxy/managers/secured.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/session.py` & `galaxy-app-23.0.4/galaxy/managers/session.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/sharable.py` & `galaxy-app-23.0.4/galaxy/managers/sharable.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/taggable.py` & `galaxy-app-23.0.4/galaxy/managers/taggable.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/tags.py` & `galaxy-app-23.0.4/galaxy/managers/tags.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/tasks.py` & `galaxy-app-23.0.4/galaxy/managers/tasks.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/tool_data.py` & `galaxy-app-23.0.4/galaxy/managers/tool_data.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/tools.py` & `galaxy-app-23.0.4/galaxy/managers/tools.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/users.py` & `galaxy-app-23.0.4/galaxy/managers/users.py`
...
### Comparing `galaxy-app-23.0.3/galaxy/managers/visualizations.py` & `galaxy-app-23.0.4/galaxy/managers/visualizations.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/managers/workflows.py` & `galaxy-app-23.0.4/galaxy/managers/workflows.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/queue_worker.py` & `galaxy-app-23.0.4/galaxy/queue_worker.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/queues.py` & `galaxy-app-23.0.4/galaxy/queues.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/structured_app.py` & `galaxy-app-23.0.4/galaxy/structured_app.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/cache.py` & `galaxy-app-23.0.4/galaxy/tool_shed/cache.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/install_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/install_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/installed_repository_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/installed_repository_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/metadata/installed_repository_metadata_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/metadata/installed_repository_metadata_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/repository_dependencies/repository_dependency_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/repository_dependencies/repository_dependency_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/tools/data_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/tools/data_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/tools/tool_panel_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/tools/tool_panel_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/galaxy_install/update_repository_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/galaxy_install/update_repository_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/metadata/metadata_generator.py` & `galaxy-app-23.0.4/galaxy/tool_shed/metadata/metadata_generator.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/repository_type.py` & `galaxy-app-23.0.4/galaxy/tool_shed/repository_type.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/tools/data_table_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/tools/data_table_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/tools/tool_validator.py` & `galaxy-app-23.0.4/galaxy/tool_shed/tools/tool_validator.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/basic_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/basic_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/container_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/container_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/dependency_display.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/dependency_display.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/hg_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/hg_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/metadata_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/metadata_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/repository_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/repository_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/shed_util_common.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/shed_util_common.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/tool_dependency_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/tool_dependency_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/tool_util.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/tool_util.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tool_shed/util/utility_container_manager.py` & `galaxy-app-23.0.4/galaxy/tool_shed/util/utility_container_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/actions/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/data_manager.py` & `galaxy-app-23.0.4/galaxy/tools/actions/data_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/data_source.py` & `galaxy-app-23.0.4/galaxy/tools/actions/data_source.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/history_imp_exp.py` & `galaxy-app-23.0.4/galaxy/tools/actions/history_imp_exp.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/metadata.py` & `galaxy-app-23.0.4/galaxy/tools/actions/metadata.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/model_operations.py` & `galaxy-app-23.0.4/galaxy/tools/actions/model_operations.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/upload.py` & `galaxy-app-23.0.4/galaxy/tools/actions/upload.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/actions/upload_common.py` & `galaxy-app-23.0.4/galaxy/tools/actions/upload_common.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/apply_rules.xml` & `galaxy-app-23.0.4/galaxy/tools/apply_rules.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/biotools.py` & `galaxy-app-23.0.4/galaxy/tools/biotools.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/build_list.xml` & `galaxy-app-23.0.4/galaxy/tools/build_list.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/build_list_1.2.0.xml` & `galaxy-app-23.0.4/galaxy/tools/build_list_1.2.0.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_export/export_remote.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_export/export_remote.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_export/export_remote.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_export/export_remote.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_export/send.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_export/send.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_export/send.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_export/send.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/biomart.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/biomart.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/biomart_test.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/biomart_test.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/cbi_rice_mart.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/cbi_rice_mart.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/data_source.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/data_source.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/ebi_sra.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/ebi_sra.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/eupathdb.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/eupathdb.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/fly_modencode.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/fly_modencode.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/flymine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/flymine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/flymine_test.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/flymine_test.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/genbank.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/genbank.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/genbank.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/genbank.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/gramene_mart.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/gramene_mart.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/hapmapmart.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/hapmapmart.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/hbvar.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/hbvar.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/import.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/import.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/import.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/import.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/intermine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/intermine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/metabolicmine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/metabolicmine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/microbial_import.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/microbial_import.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/microbial_import.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/microbial_import.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/microbial_import_code.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/microbial_import_code.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/modmine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/modmine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/mousemine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/mousemine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/ncbi_datasets.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/ncbi_datasets.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/ratmine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/ratmine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/sra.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/sra.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/ucsc_tablebrowser.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/ucsc_tablebrowser.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/ucsc_tablebrowser_archaea.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/ucsc_tablebrowser_archaea.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/ucsc_tablebrowser_test.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/ucsc_tablebrowser_test.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/upload.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/upload.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/upload.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/upload.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/worm_modencode.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/worm_modencode.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/wormbase.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/wormbase.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/wormbase_test.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/wormbase_test.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/yeastmine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/yeastmine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/data_source/zebrafishmine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/data_source/zebrafishmine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/evolution/add_scores.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/evolution/add_scores.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/evolution/add_scores.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/evolution/add_scores.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/evolution/codingSnps.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/evolution/codingSnps.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/evolution/codingSnps.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/evolution/codingSnps.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/evolution/codingSnps_filter.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/evolution/codingSnps_filter.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/expression_tools/expression_macros.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/expression_tools/expression_macros.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/expression_tools/parse_values_from_file.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/expression_tools/parse_values_from_file.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/expression_tools/pick_value.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/expression_tools/pick_value.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/extract/extract_genomic_dna.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/extract/extract_genomic_dna.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/extract/extract_genomic_dna.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/extract/extract_genomic_dna.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/extract/liftOver_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/extract/liftOver_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/extract/liftOver_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/extract/liftOver_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/CreateInterval.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/CreateInterval.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/axt_to_concat_fasta.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/axt_to_concat_fasta.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/axt_to_concat_fasta.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/axt_to_concat_fasta.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/axt_to_fasta.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/axt_to_fasta.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/axt_to_fasta.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/axt_to_fasta.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/axt_to_lav.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/axt_to_lav.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/axt_to_lav.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/axt_to_lav.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/bed2gff.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/bed2gff.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/bed_to_bigbed.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/bed_to_bigbed.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/bed_to_gff_converter.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/bed_to_gff_converter.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/catWrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/catWrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/catWrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/catWrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/changeCase.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/changeCase.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/changeCase.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/changeCase.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/commWrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/commWrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/compare.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/compare.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/condense_characters.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/condense_characters.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/condense_characters.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/condense_characters.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/convert_characters.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/convert_characters.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/convert_characters.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/convert_characters.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/cutWrapper.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/cutWrapper.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/cutWrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/cutWrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/fileGrep.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/fileGrep.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/fixedValueColumn.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/fixedValueColumn.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/fixedValueColumn.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/fixedValueColumn.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/extract_GFF_Features.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/extract_GFF_Features.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/extract_GFF_Features.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/extract_GFF_Features.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/gff_filter_by_attribute.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/gff_filter_by_attribute.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/gff_filter_by_attribute.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/gff_filter_by_attribute.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/gff_filter_by_feature_count.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/gff_filter_by_feature_count.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/gff_filter_by_feature_count.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/gff_filter_by_feature_count.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/gtf_filter_by_attribute_values_list.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/gtf_filter_by_attribute_values_list.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff/gtf_filter_by_attribute_values_list.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff/gtf_filter_by_attribute_values_list.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff2bed.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff2bed.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gff_to_bed_converter.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gff_to_bed_converter.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/grep.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/grep.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/grep.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/grep.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/grep_1.0.1.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/grep_1.0.1.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gtf2bedgraph.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gtf2bedgraph.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/gtf_to_bedgraph_converter.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/gtf_to_bedgraph_converter.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/headWrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/headWrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/join.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/join.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/joinWrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/joinWrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/joiner.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/joiner.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/joiner2.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/joiner2.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/lav_to_bed.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/lav_to_bed.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/lav_to_bed.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/lav_to_bed.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/lav_to_bed_code.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/lav_to_bed_code.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/mergeCols.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/mergeCols.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/mergeCols.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/mergeCols.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/pasteWrapper.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/pasteWrapper.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/pasteWrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/pasteWrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/random_lines_two_pass.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/random_lines_two_pass.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/randomlines.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/randomlines.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/randomlines.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/randomlines.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/remove_beginning.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/remove_beginning.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/remove_beginning.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/remove_beginning.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/secure_hash_message_digest.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/secure_hash_message_digest.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/secure_hash_message_digest.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/secure_hash_message_digest.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/sff_extract.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/sff_extract.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/sff_extractor.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/sff_extractor.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/sorter.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/sorter.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/sorter.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/sorter.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/tailWrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/tailWrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/trimmer.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/trimmer.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/trimmer.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/trimmer.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/ucsc_gene_bed_to_exon_bed.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/ucsc_gene_bed_to_exon_bed.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/ucsc_gene_bed_to_exon_bed.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/ucsc_gene_bed_to_exon_bed.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/ucsc_gene_bed_to_intron_bed.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/ucsc_gene_bed_to_intron_bed.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/ucsc_gene_bed_to_intron_bed.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/ucsc_gene_bed_to_intron_bed.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/ucsc_gene_table_to_intervals.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/ucsc_gene_table_to_intervals.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/ucsc_gene_table_to_intervals.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/ucsc_gene_table_to_intervals.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/uniq.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/uniq.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/uniq.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/uniq.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/wc_gnu.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/wc_gnu.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/wig_to_bigwig.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/wig_to_bigwig.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/wiggle_to_simple.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/wiggle_to_simple.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/filters/wiggle_to_simple.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/filters/wiggle_to_simple.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/default_notebook.ipynb` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/default_notebook.ipynb`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_askomics.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_askomics.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_bam_iobio.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_bam_iobio.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_cellxgene.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_cellxgene.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_climate_notebook.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_climate_notebook.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_ethercalc.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_ethercalc.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_geoexplorer.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_geoexplorer.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_guacamole_desktop.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_guacamole_desktop.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_hicbrowser.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_hicbrowser.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_higlass.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_higlass.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_isee.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_isee.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_jupyter_notebook.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_jupyter_notebook.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_jupyter_notebook_1.0.0.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_jupyter_notebook_1.0.0.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_metashark.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_metashark.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_mgnify_notebook.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_mgnify_notebook.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_ml_jupyter_notebook.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_ml_jupyter_notebook.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_neo4j.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_neo4j.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_openrefine.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_openrefine.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_pangeo_notebook.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_pangeo_notebook.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_panoply.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_panoply.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_paraview.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_paraview.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_pavian.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_pavian.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_phinch.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_phinch.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_pyiron.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_pyiron.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_radiant.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_radiant.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_rstudio.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_rstudio.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_simtext_app.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_simtext_app.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_vcf_iobio.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_vcf_iobio.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_vrm_editor.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_vrm_editor.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_wallace.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_wallace.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/interactivetool_wilson.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/interactivetool_wilson.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/isee/render.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/isee/render.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/interactive/simtext_app.R` & `galaxy-app-23.0.4/galaxy/tools/bundled/interactive/simtext_app.R`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/genebed_maf_to_fasta.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/genebed_maf_to_fasta.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/interval2maf.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/interval2maf.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/interval2maf.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/interval2maf.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/interval2maf_pairwise.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/interval2maf_pairwise.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/interval_maf_to_merged_fasta.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/interval_maf_to_merged_fasta.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/interval_maf_to_merged_fasta.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/interval_maf_to_merged_fasta.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_by_block_number.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_by_block_number.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_by_block_number.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_by_block_number.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_filter.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_filter.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_filter.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_filter.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_limit_size.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_limit_size.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_limit_size.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_limit_size.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_limit_to_species.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_limit_to_species.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_limit_to_species.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_limit_to_species.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_reverse_complement.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_reverse_complement.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_reverse_complement.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_reverse_complement.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_split_by_species.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_split_by_species.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_split_by_species.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_split_by_species.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_stats.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_stats.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_stats.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_stats.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_thread_for_species.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_thread_for_species.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_thread_for_species.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_thread_for_species.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_bed.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_bed.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_bed.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_bed.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_bed_code.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_bed_code.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_fasta.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_fasta.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_fasta_concat.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_fasta_concat.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_fasta_multiple_sets.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_fasta_multiple_sets.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_interval.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_interval.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/maf_to_interval.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/maf_to_interval.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/vcf_to_maf_customtrack.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/vcf_to_maf_customtrack.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/maf/vcf_to_maf_customtrack.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/maf/vcf_to_maf_customtrack.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/meme/fimo.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/meme/fimo.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/meme/fimo_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/meme/fimo_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/meme/meme.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/meme/meme.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/metag_tools/blat_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/metag_tools/blat_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/metag_tools/blat_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/metag_tools/blat_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/metag_tools/shrimp_color_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/metag_tools/shrimp_color_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/metag_tools/shrimp_color_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/metag_tools/shrimp_color_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/metag_tools/shrimp_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/metag_tools/shrimp_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/metag_tools/shrimp_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/metag_tools/shrimp_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/bwa_solid2fastq_modified.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/bwa_solid2fastq_modified.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/fastq_conversions.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/fastq_conversions.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/fastq_conversions.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/fastq_conversions.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/fastq_gen_conv.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/fastq_gen_conv.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/fastq_gen_conv.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/fastq_gen_conv.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/solid2fastq.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/solid2fastq.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/solid2fastq.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/solid2fastq.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/solid_to_fastq.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/solid_to_fastq.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/next_gen_conversion/solid_to_fastq.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/next_gen_conversion/solid_to_fastq.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/ngs_simulation/ngs_simulation.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/ngs_simulation/ngs_simulation.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/ngs_simulation/ngs_simulation.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/ngs_simulation/ngs_simulation.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/BEAM2_wrapper.sh` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/BEAM2_wrapper.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/beam.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/beam.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/gpass.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/gpass.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/gpass.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/gpass.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/ldtools.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/ldtools.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/ldtools_wrapper.sh` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/ldtools_wrapper.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/linkToDavid.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/linkToDavid.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/linkToDavid.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/linkToDavid.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/linkToGProfile.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/linkToGProfile.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/linkToGProfile.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/linkToGProfile.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/lped_to_geno.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/lped_to_geno.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/lps.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/lps.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/lps_tool_wrapper.sh` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/lps_tool_wrapper.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/master2gd_snp.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/master2gd_snp.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/master2gd_snp.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/master2gd_snp.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/master2pg.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/master2pg.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/master2pg.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/master2pg.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/mergeSnps.pl` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/mergeSnps.pl`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/pagetag.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/pagetag.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/pass.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/pass.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/senatag.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/senatag.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/sift.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/sift.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/phenotype_association/sift_variants_wrapper.sh` & `galaxy-app-23.0.4/galaxy/tools/bundled/phenotype_association/sift_variants_wrapper.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/plotting/bar_chart.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/plotting/bar_chart.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/plotting/bar_chart.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/plotting/bar_chart.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/plotting/boxplot.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/plotting/boxplot.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/solid_tools/maq_cs_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/solid_tools/maq_cs_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/solid_tools/maq_cs_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/solid_tools/maq_cs_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/solid_tools/qualsolid_boxplot_graph.sh` & `galaxy-app-23.0.4/galaxy/tools/bundled/solid_tools/qualsolid_boxplot_graph.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/solid_tools/solid_qual_boxplot.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/solid_tools/solid_qual_boxplot.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/solid_tools/solid_qual_stats.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/solid_tools/solid_qual_stats.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/solid_tools/solid_qual_stats.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/solid_tools/solid_qual_stats.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_assembly/velvetg.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_assembly/velvetg.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_assembly/velvetg_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_assembly/velvetg_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_assembly/velveth.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_assembly/velveth.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_assembly/velveth_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_assembly/velveth_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/PerM.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/PerM.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/bfast_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/bfast_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/bfast_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/bfast_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/fastq_statistics.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/fastq_statistics.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/mosaik.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/mosaik.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/srma_wrapper.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/srma_wrapper.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/sr_mapping/srma_wrapper.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/sr_mapping/srma_wrapper.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/aggregate_binned_scores_in_intervals.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/aggregate_binned_scores_in_intervals.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/aggregate_scores_in_intervals.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/aggregate_scores_in_intervals.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/filtering.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/filtering.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/filtering.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/filtering.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/grouping.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/grouping.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/grouping.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/grouping.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/gsummary.py` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/gsummary.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/gsummary.xml` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/gsummary.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/bundled/stats/r_wrapper.sh` & `galaxy-app-23.0.4/galaxy/tools/bundled/stats/r_wrapper.sh`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/cache.py` & `galaxy-app-23.0.4/galaxy/tools/cache.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/data/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/data/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/data_fetch.py` & `galaxy-app-23.0.4/galaxy/tools/data_fetch.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/data_fetch.xml` & `galaxy-app-23.0.4/galaxy/tools/data_fetch.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/data_manager/manager.py` & `galaxy-app-23.0.4/galaxy/tools/data_manager/manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/duplicate_file_to_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/duplicate_file_to_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/base_git.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/base_git.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/email.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/email.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/github.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/github.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/gitlab.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/gitlab.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/influxdb.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/influxdb.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/json.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/json.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/error_reports/plugins/sentry.py` & `galaxy-app-23.0.4/galaxy/tools/error_reports/plugins/sentry.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/errors.py` & `galaxy-app-23.0.4/galaxy/tools/errors.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/evaluation.py` & `galaxy-app-23.0.4/galaxy/tools/evaluation.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/execute.py` & `galaxy-app-23.0.4/galaxy/tools/execute.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/expressions/cwlNodeEngine.js` & `galaxy-app-23.0.4/galaxy/tools/expressions/cwlNodeEngine.js`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/expressions/evaluation.py` & `galaxy-app-23.0.4/galaxy/tools/expressions/evaluation.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/extract_dataset.xml` & `galaxy-app-23.0.4/galaxy/tools/extract_dataset.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/filter_empty_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/filter_empty_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/filter_failed_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/filter_failed_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/filter_from_file.xml` & `galaxy-app-23.0.4/galaxy/tools/filter_from_file.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/flatten_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/flatten_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/imp_exp/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/imp_exp/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/imp_exp/exp_history_to_archive.xml` & `galaxy-app-23.0.4/galaxy/tools/imp_exp/exp_history_to_archive.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/imp_exp/exp_history_to_uri.xml` & `galaxy-app-23.0.4/galaxy/tools/imp_exp/exp_history_to_uri.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/imp_exp/export_history.py` & `galaxy-app-23.0.4/galaxy/tools/imp_exp/export_history.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/imp_exp/imp_history_from_archive.xml` & `galaxy-app-23.0.4/galaxy/tools/imp_exp/imp_history_from_archive.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/imp_exp/unpack_tar_gz_archive.py` & `galaxy-app-23.0.4/galaxy/tools/imp_exp/unpack_tar_gz_archive.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/merge_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/merge_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/basic.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/basic.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/dataset_matcher.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/dataset_matcher.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/dynamic_options.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/dynamic_options.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/grouping.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/grouping.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/history_query.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/history_query.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/input_translation.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/input_translation.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/meta.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/meta.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/sanitize.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/sanitize.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/validation.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/validation.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/wrapped.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/wrapped.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/parameters/wrapped_json.py` & `galaxy-app-23.0.4/galaxy/tools/parameters/wrapped_json.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/recommendations.py` & `galaxy-app-23.0.4/galaxy/tools/recommendations.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/relabel_from_file.xml` & `galaxy-app-23.0.4/galaxy/tools/relabel_from_file.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/remote_tool_eval.py` & `galaxy-app-23.0.4/galaxy/tools/remote_tool_eval.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/repositories.py` & `galaxy-app-23.0.4/galaxy/tools/repositories.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/search/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/search/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/sort_collection_list.xml` & `galaxy-app-23.0.4/galaxy/tools/sort_collection_list.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/special_tools.py` & `galaxy-app-23.0.4/galaxy/tools/special_tools.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/tag_collection_from_file.xml` & `galaxy-app-23.0.4/galaxy/tools/tag_collection_from_file.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/test.py` & `galaxy-app-23.0.4/galaxy/tools/test.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/unzip_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/unzip_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/util/galaxyops/__init__.py` & `galaxy-app-23.0.4/galaxy/tools/util/galaxyops/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/util/maf_utilities.py` & `galaxy-app-23.0.4/galaxy/tools/util/maf_utilities.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/wrappers.py` & `galaxy-app-23.0.4/galaxy/tools/wrappers.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/tools/zip_collection.xml` & `galaxy-app-23.0.4/galaxy/tools/zip_collection.xml`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/basic.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/basic.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/cigar.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/cigar.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/genome.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/genome.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/phyloviz/__init__.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/phyloviz/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/phyloviz/baseparser.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/phyloviz/baseparser.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/phyloviz/newickparser.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/phyloviz/newickparser.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/phyloviz/nexusparser.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/phyloviz/nexusparser.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/phyloviz/phyloxmlparser.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/phyloviz/phyloxmlparser.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/data_providers/registry.py` & `galaxy-app-23.0.4/galaxy/visualization/data_providers/registry.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/genomes.py` & `galaxy-app-23.0.4/galaxy/visualization/genomes.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/plugins/config_parser.py` & `galaxy-app-23.0.4/galaxy/visualization/plugins/config_parser.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/plugins/plugin.py` & `galaxy-app-23.0.4/galaxy/visualization/plugins/plugin.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/plugins/registry.py` & `galaxy-app-23.0.4/galaxy/visualization/plugins/registry.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/plugins/resource_parser.py` & `galaxy-app-23.0.4/galaxy/visualization/plugins/resource_parser.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/visualization/plugins/utils.py` & `galaxy-app-23.0.4/galaxy/visualization/plugins/utils.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/webhooks/__init__.py` & `galaxy-app-23.0.4/galaxy/webhooks/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/work/context.py` & `galaxy-app-23.0.4/galaxy/work/context.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/extract.py` & `galaxy-app-23.0.4/galaxy/workflow/extract.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/modules.py` & `galaxy-app-23.0.4/galaxy/workflow/modules.py`
...
### Comparing `galaxy-app-23.0.3/galaxy/workflow/refactor/execute.py` & `galaxy-app-23.0.4/galaxy/workflow/refactor/execute.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/refactor/schema.py` & `galaxy-app-23.0.4/galaxy/workflow/refactor/schema.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/render.py` & `galaxy-app-23.0.4/galaxy/workflow/render.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/reports/__init__.py` & `galaxy-app-23.0.4/galaxy/workflow/reports/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/reports/generators/__init__.py` & `galaxy-app-23.0.4/galaxy/workflow/reports/generators/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/reports/generators/markdown.py` & `galaxy-app-23.0.4/galaxy/workflow/reports/generators/markdown.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/resources/__init__.py` & `galaxy-app-23.0.4/galaxy/workflow/resources/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/resources/example.py.sample` & `galaxy-app-23.0.4/galaxy/workflow/resources/example.py.sample`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/run.py` & `galaxy-app-23.0.4/galaxy/workflow/run.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/run_request.py` & `galaxy-app-23.0.4/galaxy/workflow/run_request.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/schedulers/__init__.py` & `galaxy-app-23.0.4/galaxy/workflow/schedulers/__init__.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/schedulers/core.py` & `galaxy-app-23.0.4/galaxy/workflow/schedulers/core.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/scheduling_manager.py` & `galaxy-app-23.0.4/galaxy/workflow/scheduling_manager.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/steps.py` & `galaxy-app-23.0.4/galaxy/workflow/steps.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy/workflow/trs_proxy.py` & `galaxy-app-23.0.4/galaxy/workflow/trs_proxy.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy_app.egg-info/PKG-INFO` & `galaxy-app-23.0.4/galaxy_app.egg-info/PKG-INFO`
...
### Comparing `galaxy-app-23.0.3/galaxy_app.egg-info/SOURCES.txt` & `galaxy-app-23.0.4/galaxy_app.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy_app.egg-info/requires.txt` & `galaxy-app-23.0.4/galaxy_app.egg-info/requires.txt`
...
### Comparing `galaxy-app-23.0.3/galaxy_ext/expressions/handle_job.py` & `galaxy-app-23.0.4/galaxy_ext/expressions/handle_job.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/galaxy_ext/metadata/set_metadata.py` & `galaxy-app-23.0.4/galaxy_ext/metadata/set_metadata.py`

 * *Files identical despite different names*

### Comparing `galaxy-app-23.0.3/setup.cfg` & `galaxy-app-23.0.4/setup.cfg`
...
### Comparing `galaxy-app-23.0.3/tool_shed_client/schema/__init__.py` & `galaxy-app-23.0.4/tool_shed_client/schema/__init__.py`
