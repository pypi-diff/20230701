# Comparing `tmp/arcan-1.3.3.tar.gz` & `tmp/arcan-1.3.4.tar.gz`
...
## Comparing `arcan-1.3.3.tar` & `arcan-1.3.4.tar`
...
### Comparing `arcan-1.3.3/LICENSE` & `arcan-1.3.4/LICENSE`

 * *Files identical despite different names*

### Comparing `arcan-1.3.3/README.md` & `arcan-1.3.4/README.md`

 * *Files identical despite different names*

### Comparing `arcan-1.3.3/arcan/__init__.py` & `arcan-1.3.4/arcan/__init__.py`
...
### Comparing `arcan-1.3.3/pyproject.toml` & `arcan-1.3.4/pyproject.toml`
...
### Comparing `arcan-1.3.3/PKG-INFO` & `arcan-1.3.4/PKG-INFO`
...
+Metadata-Version: 2.1 Name: arcan Version: 1.3.4 Summary: A multiheaded modern
