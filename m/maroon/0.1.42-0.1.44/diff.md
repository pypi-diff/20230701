# Comparing `tmp/maroon-0.1.42.tar.gz` & `tmp/maroon-0.1.44.tar.gz`
...
## Comparing `maroon-0.1.42.tar` & `maroon-0.1.44.tar`
...
### Comparing `maroon-0.1.42/LICENSE` & `maroon-0.1.44/LICENSE`

 * *Files identical despite different names*

### Comparing `maroon-0.1.42/maroon/cue.py` & `maroon-0.1.44/maroon/cue.py`
...
### Comparing `maroon-0.1.42/maroon/format.py` & `maroon-0.1.44/maroon/rename.py`
